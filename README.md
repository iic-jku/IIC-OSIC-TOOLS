...
- [chipify](https://github.com/santihofi/chipify) mismatch simulation wrapper for `xschem` and `ngspice` with Monte-Carlo, corner sweeps, yield analysis, and PDF/Markdown reports
