...
${ECHO_IF_DRY_RUN} docker buildx build --platform ${DOCKER_PLATFORMS} --builder ${BUILDER_NAME} ${load_or_push} ${TAG_PARAMS} --build-arg CONTAINER_TAG=${CONTAINER_TAG} -f Dockerfile.update .
