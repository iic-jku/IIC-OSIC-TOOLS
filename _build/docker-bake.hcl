...
group "tools-level-1" {
  targets = [
    "magic", "openvaf", "osic-multitool", "xyce", "covered", "cvc_rv", "fpga", "gaw3-xschem", "ghdl", "gtkwave", "irsim", "iverilog", "kactus2", "kepler-formal", "klayout", "libman", "netgen", "ngspyce", "nvc", "openems", "padring", "palace", "pulp-tools", "pyopus", "surelog", "surfer", "qflow", "qucs-s", "riscv-gnu-toolchain", "slang", "vacask", "verilator", "verible", "veryl", "xcircuit", "xschem", "yosys", "rftoolkit", "openroad", "openroad-librelane"
  ]
}
...
group "tools-level-2" {
  targets = [
    "open_pdks", "ghdl-yosys-plugin", "slang-yosys-plugin", "spike", "svck"
  ]
  # "xyce-xdm" disabled
}
